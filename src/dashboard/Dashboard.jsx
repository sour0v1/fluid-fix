...
const Dashboard = () => {
    ...
    return (
        <div className='grid lg:grid-cols-12 lg:my-9 font-poppins relative'>
            ...
            <div className={`lg:col-span-3 text-center lg:text-left p-6  bg-opacity-100 lg:bg-opacity-10 flex flex-col gap-6 absolute lg:static w-full z-30 text-[#094074]  bg-white lg:bg-[#094074]  left-0 top-16 transition transform duration-300 ${up ? 'translate-y-0' : '-translate-y-[1000px] lg:translate-y-0'}`}>
            ...
            <div className='border lg:col-span-9 p-9'>
                Content
            </div>
        </div>
    );
