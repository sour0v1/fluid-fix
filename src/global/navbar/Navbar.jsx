...
const Navbar = () => {
    ...
    return (
        <div className='w-full bg-[#094074]'>
            <div className='py-6 px-6 lg:px-0 text-white flex justify-between items-center max-w-6xl mx-auto'>
                ...
                <div className={`font-poppins fixed md:static lg:static flex border md:border-none lg:border-none border-white flex-col md:flex-row lg:flex-row bg-[#094074] md:justify-center lg:justify-center items-center gap-9 inset-0 pt-16 pb-6 md:pt-0 lg:pt-0 md:pb-0 lg:pb-0 transform transition duration-300 z-20 ${open ? '' : '-translate-x-full md:-translate-x-0 lg:-translate-x-0'}`}>
                    <NavLink onClick={() => setOpen(!open)} className='relative hover-underline inline-block'>Home</NavLink>
                    <NavLink onClick={() => setOpen(!open)} className='relative hover-underline inline-block'>Services</NavLink>
                    <NavLink onClick={() => setOpen(!open)} className='relative hover-underline inline-block'>About Us</NavLink>
