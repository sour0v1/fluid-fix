...
const Footer = () => {
    return (
        <div className='w-full bg-[#094074] px-6 lg:px-0s'>
            <div className='text-white py-6 md:py-9 lg:py-16 font-poppins flex flex-col md:flex-row lg:flex-row justify-between gap-9 max-w-6xl mx-auto'>
                {/* footer 1 */}
